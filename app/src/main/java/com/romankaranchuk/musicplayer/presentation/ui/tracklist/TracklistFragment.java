...
public class TracklistFragment extends Fragment implements
    MusicRepositoryImpl.AlbumsRepositoryObserver {
    ...
    private MusicRepositoryImpl mRepository;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mRepository = MusicRepositoryImpl.getInstance(getContext());
...
//                    args.putParcelable(SELECTED_SONG, selectedSong);
                    ...
                    audioSettingsFragment.show(getActivity().getSupportFragmentManager(), "dialog");
                    return true;
                }
            };
