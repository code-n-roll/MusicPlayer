...
//                selectedSong.getAlbumId();
    ...
    public void onAttach(Context context){
        ...
        Log.d(LOG_TAG, "EditAudioFragment onAttach");
    }
    @Override
    ...
    public void onStart(){
        super.onStart();
        Log.d(LOG_TAG, "EditAudioFragment onStart");
    }
    @Override
    public void onResume(){
        super.onResume();
        Log.d(LOG_TAG, "EditAudioFragment onResume");
    }
    @Override
    public void onPause(){
        super.onPause();
        Log.d(LOG_TAG, "EditAudioFragment onPause");
    }
    @Override
    public void onStop(){
        super.onStop();
        Log.d(LOG_TAG, "EditAudioFragment onStop");
    }
    @Override
    public void onDestroyView(){
        super.onDestroyView();
        Log.d(LOG_TAG, "EditAudioFragment onDestroyView");
    }
    @Override
    public void onDestroy(){
        super.onDestroy();
        Log.d(LOG_TAG, "EditAudioFragment onDestroy");
    }
    @Override
    public void onDetach(){
        super.onDetach();
        Log.d(LOG_TAG, "EditAudioFragment onDetach");
    }
